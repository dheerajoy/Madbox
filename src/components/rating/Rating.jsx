  ...
  return (
    <div className="ratingCon">
        ...
        <div className="ratingTexts">
          ...
          <div>
            <p>
              ...
              share their experiences at Madbox.
            </p>
          </div>
        </div>
      ...
      <div className="RatingCard">
        <RatingCard
          rating={4.9}
          description="Culture & Values"
          gradientColors={["#00C2FF", "#4FF29F"]}
        />
        <RatingCard
          rating={4.7}
          description="Diversity & Inclusion"
          gradientColors={["#AB03FF", "#38B7FF"]}
        />
        <RatingCard
          rating={4.5}
          description="Work/Life Balance"
          gradientColors={["#FF596F", "#FFBF05"]}
        />
        <RatingCard
          rating={4.6}
          description="Senior Leadership"
          gradientColors={["#FD549A", "#8E74FF"]}
        />
        <RatingCard
          rating={4.4}
          description="Career Opportunities"
          gradientColors={["#FF7326", "#FF4DC6"]}
        />
      </div>
    </div>
  );
