  ...
  const [videoCarousel] = useState([
    {
      id: 1,
      description:
        "“Help the team get in the best conditions to create the best games”",
      name: "Arthur",
      role: "Producer",
      Img: second,
    },
    ...
    },
    {
      id: 4,
      description:
        '"We work on remaking some bootleg version of our games for ad purposes.”',
      name: "Ossama",
        ...
        {videoCarousel.map((item, index) => (
          ...
          >
            ...
            <div className="card-bottom">
              <h3
                className={
                  index === 0 && focusedCard !== index ? "reduced-opacity" : ""
                }
              >
                {item.description}
              </h3>
              <p
                id="names"
                className={`name-${item.name.toLowerCase()} name ${
                  index === 0 && focusedCard !== index ? "reduced-opacity" : ""
                } `}
              >
                {item.name}
